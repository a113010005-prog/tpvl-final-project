...
**困難一：Yoast SEO 燈號**
中文關鍵字的偵測不如英文準確，Yoast 對中文關鍵字的辨識一直出現問題，嘗試多次修改後，最終改用英文關鍵字才解決。

**困難二：Markdown 與 WordPress 的格式轉換**
直接貼 Markdown 文字到 WordPress，標題和段落格式無法被正確辨識，Yoast 讀到的字數只有27字。最後改用 HTML 格式透過程式碼編輯器貼入才解決。
